...
public class TestData {
    ...
    private static InputData compileUnsatisfiableDataSet() {
        ...
        dataSet.addCapability(Capability.newCapability(new HashSet<Proposition>(), p0));
        dataSet.addCapability(Capability.newCapability(new HashSet<Proposition>(), p3));
        dataSet.addCapability(Capability.newCapability(new HashSet<Proposition>(), p4));
        return dataSet;
    }
    ...
    private static InputData compileRunningExampleDataSet() {
        ...
        dataSet.addCapability(Capability.newCapability(new HashSet<>(Arrays.asList(haveTools)), toolsProvided));
        // Capability({HaveMaterials}, MaterialsProvided)
        dataSet.addCapability(Capability.newCapability(new HashSet<>(Arrays.asList(haveMaterials)), materialsProvided));
        // Capability({}, ToolsPaidCash)
        dataSet.addCapability(Capability.newCapability(new HashSet<Proposition>(), toolsPaidCash));
        // Capability({}, ToolsPaidCard)
        dataSet.addCapability(Capability.newCapability(new HashSet<Proposition>(), toolsPaidCard));
        // Capability({}, MaterialsPaidCash)
        dataSet.addCapability(Capability.newCapability(new HashSet<Proposition>(), materialsPaidCash));
        // Capability({}, MaterialsPaidCard)
        dataSet.addCapability(Capability.newCapability(new HashSet<Proposition>(), materialsPaidCard));
        // Capability({}, FurniturePaid)
        dataSet.addCapability(Capability.newCapability(new HashSet<Proposition>(), furniturePaid));
        // Capability({}, FirstBuilderPaid)
        dataSet.addCapability(Capability.newCapability(new HashSet<Proposition>(), firstBuilderPaid));
        // Capability({}, SecondBuilderPaid)
        dataSet.addCapability(Capability.newCapability(new HashSet<Proposition>(), secondBuilderPaid));
        return dataSet;
    }
